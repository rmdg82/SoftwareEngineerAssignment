...
namespace SoftwareEngineerAssignment.Tests.Controllers;
...
public class GiveMeAdviceControllerTests
{
    ...
    [Fact]
    public async Task GiveMeAdvice_WhenCalledWithSuccessAndNoCachedElement_ReturnOk()
    {
        // Arrange
        var correctRequest = new GiveMeAdviceRequest()
        {
        ...
        _mockCache
            .Setup(x => x.Get<GiveMeAdviceResponse>(correctRequest))
            .Returns(value: null);

        _controller = new GiveMeAdviceController(_mockLogger.Object, _mockAdviceSlipService.Object, _mockCache.Object);
        ...
        _mockCache.Verify(x => x.Set(correctRequest, giveMeAdviceResponse, It.IsAny<MemoryCacheEntryOptions>()), Times.Once);
    }
    ...
    [Fact]
    public async Task GiveMeAdvice_WhenCalledWithCache_ReturnOk()
    {
        // Arrange
